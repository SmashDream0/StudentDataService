...
namespace StudentDataService.Entity.Specification.Base.Expressions
{
    /// <summary>
    ...
    public abstract class ExpressionVisitor
    {
        ...
        protected virtual Expression VisitUnary(UnaryExpression unaryExpression)
        {
            ...
            return (operand != unaryExpression.Operand)
                       ? Expression.MakeUnary(unaryExpression.NodeType, operand, unaryExpression.Type,
        ...
        protected virtual Expression VisitConditional(ConditionalExpression conditionalExpression)
        {
            ...
            return (test != conditionalExpression.Test || ifTrue != conditionalExpression.IfTrue ||
